...
for category in data:
    for app in category['apps']:
        if app['name'] in prompts_map:
            app['prompts'] = prompts_map[app['name']]
        else:
            ...
            elif category['name'] == 'AUDIO & MUSIQUE':
...
print('data.json updated with prompts successfully!')
